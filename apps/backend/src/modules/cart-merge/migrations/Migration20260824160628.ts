...
export class Migration20260824160628 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`CREATE UNIQUE INDEX IF NOT EXISTS "UQ_cart_merge_result_idempotency_record" ON "cart_merge_result" ("idempotency_record_id");`);
    ...
    this.addSql(`CREATE UNIQUE INDEX IF NOT EXISTS "UQ_cart_review_review_ref" ON "cart_review" ("review_ref");`);
    this.addSql(`CREATE UNIQUE INDEX IF NOT EXISTS "UQ_cart_review_merge_result" ON "cart_review" ("merge_result_id");`);
