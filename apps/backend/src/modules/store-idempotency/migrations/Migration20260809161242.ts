...
export class Migration20260809161242 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`CREATE UNIQUE INDEX IF NOT EXISTS "UQ_store_idempotency_record_claim_scope" ON "store_idempotency_record" ("operation", "actor_scope_hash", "resource_scope_hash", "idempotency_key_hash") WHERE deleted_at IS NULL;`);
