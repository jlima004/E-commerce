...
import { serializeStoreCartPreOrder } from "../../../../carts/serializers"
...
type AttachRequest = MedusaRequest &
...
export async function POST(req: MedusaRequest, res: MedusaResponse) {
  const request = req as AttachRequest

  if (!isAttachNewContractPresent(request)) {
